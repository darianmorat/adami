...
export const Footer = () => {
  return (
    <footer className="flex flex-col bg-accent-2 p-10 pb-4 text-white">
      <div className="flex flex-wrap justify-center gap-10">
        <div className="flex max-w-max items-center border-r border-white/15 px-10 pr-20">
          <Logo className="brightness-0 invert" size="footer" />
        </div>

        <div className="max-w-max flex-1 px-10">
      ...
      <div className="mt-10 flex justify-between border-t border-white/15 pt-4 text-xs text-white/70">
